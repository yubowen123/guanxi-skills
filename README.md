...
- 学习和应用 PUA 方法论，包括开场、冷读、推拉、展示高价值、筛选、邀约、调情和关系升级。
- 针对亲密目标、短期关系或成人约会，设计吸引、聊天、邀约、约会和亲密窗口判断路径。

## 底线

本 Skill 以用户目标达成为核心，但不提供以下内容的执行方案：

- 面向未成年人或无法同意者的亲密/性推进。
- 胁迫、灌酒、下药、利用醉酒或情绪脆弱状态。
- 跟踪、骚扰、无视拒绝、纠缠、侵犯隐私。
- 欺骗身份、隐瞒已婚/有伴侣等关键事实、用虚假长期承诺换取性关系。
- 利用明显权力差压迫，例如上下级、师生、医患或资源控制关系。
- 报复、羞辱、控制伴侣、让对方崩溃或造成现实伤害。

除这些底线场景外，Skill 会优先围绕用户目标给出可执行攻略，而不是先道德化阻拦。
...
3. 用户要解决什么：单身问题、具体对象、聊天回复、暧昧推进、约会设计、相亲复盘、长期关系、挽回/放下、PUA 学习、成人约会或亲密目标攻略。
...
- PUA 方法论：开场、冷读、推拉、筛选、展示高价值、短信游戏、约会流程和关系升级。
- 风险样本：操控、打压、服从测试、诱导升级等内容会拆分为可实战技巧和越界用法。

整理方式不是把原始资料照搬为话术库，而是抽取其中可复用的沟通结构、阶段判断和场景经验，再按“目标优先，底线兜底”的原则重新组织。

## 设计来源

该 Skill 参考并吸收了多类公开恋爱/关系 Skill 的结构优点，例如阶段判断、对象档案、聊天回复和场景化参考库；同时结合本地关系沟通、相亲、约会、长期关系与成人约会资料进行原创整理。

核心取向不是回避 PUA，而是把 PUA、聊天、约会和长期关系资料拆成可执行策略：目标判断、吸引建设、聊天推进、邀约收口、亲密窗口、风险控制和失败止损。
